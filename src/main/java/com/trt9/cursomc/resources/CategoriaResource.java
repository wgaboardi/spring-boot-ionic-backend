...
import com.trt9.cursomc.dto.CategoriaDTO;
import com.trt9.cursomc.services.CategoriaService;
...
public class CategoriaResource {
	...
	public ResponseEntity<Void> update(@Valid @RequestBody CategoriaDTO objDto, @PathVariable Integer id) {
		Categoria obj = service.fromDTO(objDto); // converte DTO para objeto
		obj.setId(id);
